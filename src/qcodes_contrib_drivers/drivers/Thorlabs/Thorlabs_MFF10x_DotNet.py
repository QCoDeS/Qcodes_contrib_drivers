...
from .private.DotNetAPI.FilterFlipperCLI import FilterFlipper
from .private.DotNetAPI.qcodes_thorlabs_integration import ThorlabsQcodesInstrument

log = logging.getLogger(__name__)

class ThorlabsMFF10x(FilterFlipper, ThorlabsQcodesInstrument):
    """
    Driver for interfacing with the Thorlabs MFF10x
    via the QCoDeS framework and the .NET API.

    This class allows for control and management of the MFF10x.
    ...
    def __init__(
        ...
        name: str,
        serial_number: str,
        startup_mode_value: str = 'UseDeviceSettings', # UseDeviceSettings, UseFileSettings, UseConfiguredSettings
    ...
    def _import_device_dll(self):
        ...
        self._add_dll('Thorlabs.MotionControl.FilterFlipperCLI.dll')
        self._import_dll_class('Thorlabs.MotionControl.FilterFlipperCLI', 'FilterFlipper')
    ...
    def _get_api_interface_from_dll(self, serial_number: str):
        ...
        return self._dll.FilterFlipper.CreateFilterFlipper(serial_number)
