...
from .private.DotNetAPI.KCube_LaserSourceCLI import KCubeLaserSource
from .private.DotNetAPI.qcodes_thorlabs_integration import ThorlabsQcodesInstrument

log = logging.getLogger(__name__)

class ThorlabsKLSnnn(KCubeLaserSource, ThorlabsQcodesInstrument):
    """
    Driver for interfacing with the Thorlabs KLSnnn
    via the QCoDeS framework and the .NET API.

    This class allows for control and management of the KLSnnn.
    ...
    def _import_device_dll(self):
        ...
        self._add_dll('Thorlabs.MotionControl.KCube.LaserSourceCLI.dll')
        self._import_dll_class('Thorlabs.MotionControl.KCube.LaserSourceCLI', 'KCubeLaserSource')
    ...
    def _get_api_interface_from_dll(self, serial_number: str):
        ...
        return self._dll.KCubeLaserSource.CreateKCubeLaserSource(serial_number)
