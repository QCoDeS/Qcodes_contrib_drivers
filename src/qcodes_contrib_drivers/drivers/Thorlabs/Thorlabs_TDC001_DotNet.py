...
from .private.DotNetAPI.TCube_DCServoCLI import TCubeDCServo
from .private.DotNetAPI.qcodes_thorlabs_integration import ThorlabsQcodesInstrument

log = logging.getLogger(__name__)

class ThorlabsTDC001(TCubeDCServo, ThorlabsQcodesInstrument):
    """
    Driver for interfacing with the Thorlabs TDC001
    via the QCoDeS framework and the .NET API.

    This class allows for control and management of the TDC001.
    ...
    def _import_device_dll(self):
        ...
        self._add_dll('Thorlabs.MotionControl.TCube.DCServoCLI.dll')
        self._import_dll_class('Thorlabs.MotionControl.TCube.DCServoCLI', 'TCubeDCServo')
    ...
    def _get_api_interface_from_dll(self, serial_number: str):
        ...
        return self._dll.TCubeDCServo.CreateTCubeDCServo(serial_number)
